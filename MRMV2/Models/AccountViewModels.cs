...
namespace MRMV2.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        public string Security_Question_Answer_1 { get; set; }

        [Required]
        [Display(Name = "Security Question 2")]
        public string Security_Question_Answer_2 { get; set; }

        [Required]
        [Display(Name = "Security Question 3")]
        public string Security_Question_Answer_3 { get; set; }
        ...
        public string User_Picture_Path { get; set; }
